...
function CreateBlip(pos,sprite,color,text,scale,display,shortRange,highDetail)
  ...
  SetBlipScale                (blip, (scale or 0.3))
...
function ShowNotification(msg)
  ...
  AddTextComponentSubstringPlayerName("<font face=\'Roboto\'>"..msg)
...
DrawText3D = function(_x,_y,_z, text, size)
  ...
  if onScreen then
    ...
    AddTextComponentString("<font face=\'Roboto\'>"..text)
    DrawText(x, y)
  end
end
