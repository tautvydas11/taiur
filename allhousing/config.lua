...
Config = {
    ...
    BlipEmptyColor = 37, -- must be set regardless of option above.
    BlipOwnerColor = 26, -- must be set regardless of option above.
    BlipOwnedColor = 43, -- must be set regardless of option above.
    ...
    CreationJobs = {
        meras = { -- JOB NAME.
            ...
            account = 'society_meras', -- society account name
